...
Citra yang digunakan dalam eksperimen ini adalah berkas lokal \texttt{img/cat.jpeg}. Citra tersebut berformat JPEG dengan ukuran 736 $\times$ 981 piksel dan memiliki tiga kanal warna (RGB).
